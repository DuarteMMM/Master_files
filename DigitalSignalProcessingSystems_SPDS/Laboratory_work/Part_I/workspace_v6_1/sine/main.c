...
void main( void )
{
    ...
    /* Configure AIC3204 */
       ...
       Int16 	SineWave[]={0,383,707,924,1000,924,707,383,0,-383,-707,-924,-1000,-924,-707,-383,0};
       Int16	index, gain=33;
       Int16    SineBuffer[16];
       ...
       while(1) {
                    ...
                    DataInLeft = I2S0_W0_MSW_R;  // 16 bit left channel received audio data
          	        DataInRight = I2S0_W1_MSW_R;  // 16 bit right channel received audio data
    				/* Write Digital audio */
          	        while((Xmit & I2S0_IR) == 0);  // Wait for interrupt pending flag
    				I2S0_W0_MSW_W = DataOutLeft;  // 16 bit left channel transmit audio data
          	        I2S0_W1_MSW_W = DataOutRight;  // 16 bit right channel transmit audio data
